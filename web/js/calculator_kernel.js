class Calculator {
    ...
    eq() {
        ...
        this.num2 = Big(this.elt.value);
        let num = this._calc(this.num1, this.num2, this.operator);
        this.clear_num();
        if (num != null) {
            this.elt.value = num;
            return true;
...
let widgetCalculator = new Calculator($('#calc-input-widgets')[0], $('#widgets .calc>.content')[0]);
let appCalculator = new Calculator($('#calc-input')[0], $('#win-calc>.keyb')[0]);
